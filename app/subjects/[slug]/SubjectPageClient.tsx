...
//
// Bu fayl QƏSDƏN ayrıdır: səhifənin özü (page.tsx) server komponentidir və
// generateStaticParams ilə bütün fənn ünvanlarını build zamanı hazırlayır.
// Əvvəl hamısı bir "use client" faylı idi — dinamik seqment + client komponent
// = Next hər sorğuda Worker-də render edirdi və canlıda "Error 1102
// (exceededCpu)" verirdi. İndi HTML statikdir, Worker heç render etmir.
